...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-1345394-2"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-1345394-2');

	  gtag('config', 'GA_MEASUREMENT_ID', {
		  'user_id': '<?=md5($member[no].$member[user_id])?>' 
		});
	</script>
	...
	<meta name="google-site-verification" content="EB7A7bHShLk6McNAcBBrUGAV4XWxhw-xS14Jfc40srk" />
