...
<?
	...
	if($canPlay){
		if($playCount >= $fiducialPlayCount and $NowPlayingCount < $AttandMaxCountOver3 or $playCount < $fiducialPlayCount and $NowPlayingCount < $AttandMaxCountUnder3){
			...
			<br>
			<!-- -->
			<input type="submit" name="temp" value="게임 참여하기" style="border: 2px solid #666666; background-color: black; color: #666666; padding: 5px 15px; margin: 4px 2px; text-align: center; font-family: '맑은 고딕', '나눔고딕', '돋움'; text-decoration: none; font-size: 14px;">
			</form>
		<?}
