...
<td nowrap rowspan=2 width=<?=$img_w?> height=<?=$img_h?> style='padding-right:5;'>
   ...
   <tr>
   <td nowrap><img src=<?=$dir?>/head.gif border=0> <?=stripslashes($data[subject])?> <?=$a_modify?><img src=<?=$dir?>/modify.gif border=0></a><?=$a_delete?><img src=<?=$dir?>/delete.gif border=0></a></td>
   </tr>
   <tr>
