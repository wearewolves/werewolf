...
//			$printCommentType .="<INPUT TYPE=radio NAME=c_type value=비밀 checked onclick=setColor('비밀')>비밀($entry[secret]/40)</input>" ;
	 ...
	 <?//}?>
	  ...
	  <tr bgcolor=111111>
			<td width=100%>		
			<div name="memoedit" id="memoedit" style="color:#000;padding :5px;text-align:justify;line-height:1.5em;font-size:12px;min-height:80px;min-width:600px;word-wrap:break-word; _width:100%;_height:80px;_position:relative;_top:0px;_left:-4px;white-space:pre;display:inline-block;" contenteditable></div>
