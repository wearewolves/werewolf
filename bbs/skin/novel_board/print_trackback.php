...
echo "<table id='tb'>";
echo "<thead><tr><td>트랙백 주소</td><td><span onclick=toClip('http://werewolf.co.kr/bbs/zerotb.php?id=$id&no=$no') onfocus=blur() title='Click to copy'>
<font color='#BC593B'>http://werewolf.co.kr/bbs/zerotb.php?id=$id&no=$no</font></span></td></tr></thead>";
